...
- [X] &nbsp;&nbsp;
  moved the command to run the bots to their class' file
- [X] &nbsp;&nbsp;
  moved util functions and classes to util folder
- [X] &nbsp;&nbsp;
  added static help embed to providence
- [X] &nbsp;&nbsp;
  added static help embed to jack
- [X] &nbsp;&nbsp;
  moved cogs to cogs folder
- [X] &nbsp;&nbsp;
